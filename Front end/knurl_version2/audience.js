        ...
        p.draw = () => {
            ...
            switch(state) { 
                ...
                case 1:
                    ...
                    p.textSize(36);
                    p.textStyle(p.BOLD);
                    p.text("THIS IS", p.width/2, p.height/2-160);
                    p.text("AN EXPERIMENT :)", p.width/2, p.height/2-110);
                    p.textStyle(p.NORMAL);
                    p.textSize(15);
                    p.text("live coding with the audience", p.width/2, p.height/2-62, p.width-80, 60);
                    ...
                    p.textStyle(p.NORMAL);
                    p.textSize(15);
                    p.text("watch that screen; your input is part of the performance", p.width/2, p.height/2+97, p.width-80, 60);
